...
public class FavouriteActivity extends Activity implements SearchPanel.SearchListener {
    ...
    private void initTitleBar() {
        ...
        textTitle.setText(R.string.my_favourites);
    ...
    private void initViews() {
        ...
        try {
            ...
            mCategoryAdapter = new CategoryAdapter(this, mSuggestionCategories, true);
    ...
    public void onItemClick(int position) {
        ...
        selectedCategory.nSelected = (selectedCategory.nSelected > 0) ? 0 : 1;

        for (BlogCategory blogCategory : SkilledManager.mCategoryList) {
            if (blogCategory.strId.equals(selectedCategory.strId)) {
                blogCategory.nSelected = selectedCategory.nSelected;
            }
        }

        SkilledManager.saveSelectedCategories(this);
        mCategoryAdapter.notifyDataSetChanged();
    }
